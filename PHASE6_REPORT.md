...
Affected modules: Core sensing/brain estimates, new Core Skill learning and adaptation, simulation sensor and Skill runtimes, motor primitive, browser debug panel, and focused tests. Implementation commit: `65a6d08`; intact-baseline test commit: `3a4c214`. Pull request: [#9 — Phase 6: Skill & Adaptation](https://github.com/TTTT-T/Morphodyne/pull/9), targeting `main`.
